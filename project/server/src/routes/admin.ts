...
router.post('/entities', (req: AuthRequest, res: Response) => {
  ...
  const newEntity = {
    ...
    targetType: entity.targetType ?? entity.attackType ?? null,
    targetOrder: entity.targetOrder ?? entity.attackOrder ?? null,
    priorityTarget: entity.priorityTarget ?? null,
    targetFaction: entity.targetFaction ?? null,
    preloadedDynamicAffixes: entity.preloadedDynamicAffixes ?? undefined,
...
router.put('/entities/:id', (req: AuthRequest, res: Response) => {
  ...
  const updated = {
    ...
    targetType: entity.targetType !== undefined ? entity.targetType : (entity.attackType !== undefined ? entity.attackType : existing.targetType ?? existing.attackType),
    targetOrder: entity.targetOrder !== undefined ? entity.targetOrder : (entity.attackOrder !== undefined ? entity.attackOrder : existing.targetOrder ?? existing.attackOrder),
    priorityTarget: entity.priorityTarget !== undefined ? entity.priorityTarget : existing.priorityTarget,
    targetFaction: entity.targetFaction !== undefined ? entity.targetFaction : existing.targetFaction,
    preloadedDynamicAffixes: entity.preloadedDynamicAffixes !== undefined ? entity.preloadedDynamicAffixes : existing.preloadedDynamicAffixes,
